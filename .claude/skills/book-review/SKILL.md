...
## Integration with book-implement

This skill works standalone. However:
- If code came from book-implement skill, review will focus on implementation quality
...
The skill doesn't require book-implement to have run first—any uncommitted code can be reviewed.
